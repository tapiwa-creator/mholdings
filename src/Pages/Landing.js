          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
               Mkunyadze Holdings delivers innovative technology and engineering solutions across diverse sectors, creating lasting value and sustainable outcomes for clients.
              </p>
            ...
            <div className="flex justify-center lg:justify-end items-center h-full">
              <div className="relative w-full">
                <img 
                  src="/landing.jpg" 
                  alt="Mkunyadze Holdings Professional" 
                  className="w-full h-auto min-h-[400px] lg:min-h-[500px] object-contain"
                />
              </div>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Team Grid - 3 cards of same size as Core Sectors */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed text-center">
                  A visionary starter who turned a big idea into reality-offering fresh innovative solutions across multiple fields like IT, architecture and more.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm hover:shadow-xl transition-shadow duration-300 border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed text-center">
                  A forward thinking strategist who drives eco-friendly practices across the orginization, making sure sustainability aligns with company growth and delivers measurable ROI
                </p>
              </div>
            </div>
          </div>
