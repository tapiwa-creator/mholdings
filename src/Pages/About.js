...
const About = () => {
  return (
    <>
      <Seo title="About Us" description="Discover the legacy of ElevateLT in IT services, software development, architectural planning, and construction." path="/about" />
