  ...
  return (
    <>
      ...
      <Modal isOpen={termsOpen} onClose={() => setTermsOpen(false)} title="Terms of Service">
        ...
        {bodyText('LT Solutions provides web development, architectural planning, and IT consultancy services. All work is delivered under agreed project terms outlined in individual client proposals.')}
